...
- Recall previous inputs with the Up/Down arrow keys (history persists across sessions in `~/.bioinformatics_prompts_history`, created with owner-only `0600` permissions since it stores everything you type in plaintext)
